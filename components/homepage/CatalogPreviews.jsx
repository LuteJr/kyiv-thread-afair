...
export default function CatalogPreviews() {
  return (
    <>
      <section className="catalog-preview container text-center">
        <header>
          <h1>
      ...
      <section className="catalog-preview container text-center grid-layout">
        <header>
          <h1>
            <span>Glamour</span> Suits
          </h1>
      ...
      <section className="catalog-preview container text-center flex-layout">
        <header>
          <h1>
